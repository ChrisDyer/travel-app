...
export const appDestinations = [
  { id: "dashboard", label: "Dashboard", href: "https://zo-bot.com/", icon: Gauge },
  ...
  { id: "newsletters", label: "Newsletters", href: "https://zo-bot.com/newsletter/", icon: Newspaper },
  { id: "home", label: "Home", href: "https://home.zo-bot.com/", icon: Home },
  { id: "records", label: "Records", href: "https://zo-bot.com/records/", icon: ScrollText },
